    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-playfair font-bold text-gold leading-tight mb-6 animate-slideUp opacity-0" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
            СВЕЖЕЕ МЯСО<br />ПО СТАРЫМ<br />РЕЦЕПТАМ
          </h1>
          
          <p className="text-cream text-lg md:text-xl mb-10 max-w-2xl opacity-0 animate-slideUp" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
            Премиальное мясо отборного качества, выдержанное по старинным традициям и доступное для истинных ценителей вкуса
          </p>
          
          <div className="flex flex-wrap gap-4 opacity-0 animate-slideUp" style={{ animationDelay: '0.9s', animationFillMode: 'forwards' }}>
          ...
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-6 opacity-0 animate-slideUp" style={{ animationDelay: '1.2s', animationFillMode: 'forwards' }}>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-pulse">
        <div className="flex flex-col items-center">
          ...
          <div className="w-6 h-10 border-2 border-cream rounded-full flex justify-center">
            <div className="w-1 h-2 bg-cream rounded-full mt-1 animate-bounce"></div>
          </div>
        </div>
      </div>
    </section>
